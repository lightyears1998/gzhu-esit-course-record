...
但话说回来，我的“4核2.1GHz AMD FX-7500CPU + 8GB800MHZ内存”内存的联想小新V1070，运行Hyper V时卡在了Windows的启动界面上的动画都卡，Hyper V虚拟化接口比AMD-V引擎慢至少一百倍。即使Hyper V能与VirtualBox共存，平时我也不会启动它。它，实在是，太慢了。
